...
\usepackage{graphicx}
% Allow graphics and \input to look in ../out/ (sibling of latex/)
\graphicspath{{../out/}{./}}
\makeatletter\def\input@path{{../out/}{./}}\makeatother
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.9\linewidth]{fig_influence_boxplots.pdf}% TODO: export from notebook
...
\begin{figure}[H]
  ...
  \begin{subfigure}{.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{fig_feat_gain_before.pdf}% TODO
    \caption{Baseline feature gain (example: ILPD)}
  \end{subfigure}\hfill
  \begin{subfigure}{.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{fig_feat_gain_after.pdf}% TODO
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.7\linewidth]{fig_category_counts.pdf}% TODO
